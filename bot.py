...
logger = logging.getLogger('NEROSYS.Main')
...
async def main():
    bot = commands.Bot(
        command_prefix="//", # Préfixe des commandes (en dehors des commandes slash)
        description="Bot Discord modulaire", # Courte description interne
        intents=intents,
        help_command=None
    )
